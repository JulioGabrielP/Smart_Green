...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final user = getUserData(); // Mock de dados do usuário
          ...
          children: [
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      child: user != null && user.name.isNotEmpty
                          ...
                          : const Icon(Icons.account_circle_rounded, size: 48, color: Colors.white),
                    ),
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    trailing: DropdownButton<String>(
                      ...
                      underline: const SizedBox.shrink(), // Remove a linha padrão do Dropdown
                    ),
                  ),
                  const Divider(indent: 16, endIndent: 16, height: 1),
                  ListTile(
            ...
            Card(
              ...
              child: Column(
                children: [
                  ListTile(
                    leading: Icon(Icons.history_rounded, color: colorScheme.onSurface.withOpacity(0.7)),
                  ...
                  const Divider(indent: 16, endIndent: 16, height: 1),
                  ListTile(
                    leading: Icon(Icons.info_outline_rounded, color: colorScheme.onSurface.withOpacity(0.7)),
                    title: const Text('Sobre o Smart Green'),
                    trailing: Icon(Icons.chevron_right, color: colorScheme.onSurface.withOpacity(0.5)),
                    onTap: () {
                      // Simular navegação para uma página "Sobre"
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Navegar para a página "Sobre"')),
                      );
                    },
                  ),
                ],
            ...
            ElevatedButton.icon(
              style: ElevatedButton.styleFrom(
                backgroundColor: colorScheme.error, // Cor vermelha para indicar ação de cuidado
                foregroundColor: colorScheme.onError, // Texto branco para contraste
              ...
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Realizando logout...')),
                );
