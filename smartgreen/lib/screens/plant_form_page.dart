...
class _PlantFormPageState extends State<PlantFormPage> {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildSectionTitle(cs, Icons.eco, 'Identificação'),
                const SizedBox(height: 12),
                _buildIdentificationCard(cs),
                const SizedBox(height: 24),

                // SEÇÃO 2: Condições Ideais
                _buildSectionTitle(cs, Icons.tune, 'Condições Ideais'),
                const SizedBox(height: 12),
                _buildConditionsCard(cs),
                const SizedBox(height: 24),

                // SEÇÃO 3: Data de Plantio
                _buildSectionTitle(cs, Icons.calendar_today, 'Data de Plantio'),
                const SizedBox(height: 12),
                _buildDateCard(cs),
                ...
                // Botão de Salvar
                CustomButton(
                  label: _isSaving ? 'Salvando...' : 'Salvar Planta',
  ...
  Widget _buildIdentificationCard(ColorScheme cs) {
    return Card(
      elevation: 0,
      color: cs.surface,
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: Icon(Icons.local_florist, color: cs.primary),
                helperText: 'Digite pelo menos 3 letras para sugestões',
                helperMaxLines: 2,
              ),
              onChanged: (value) {
                _debounce?.cancel();
            ...
            if (_suggestions.isNotEmpty) _buildSuggestionsCard(cs),
          ],
        ),
      ),
    );
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                leading: s.imageURL.isNotEmpty
                    ...
                    : CircleAvatar(
                        backgroundColor: cs.primaryContainer,
                        child: Icon(Icons.local_florist, color: cs.primary),
                      ),
                title: Text(
                  s.nome,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Icon(Icons.thermostat, size: 18, color: cs.primary),
                const SizedBox(width: 8),
                Text(
                  'Temperatura (°C)',
                  style: TextStyle(
                ...
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: 'Mínima',
                      hintText: '15',
                      prefixIcon: Icon(Icons.arrow_downward, size: 18, color: cs.primary),
                      helperText: 'Entre -50 e 70 °C',
                    ),
                ...
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: 'Máxima',
                      hintText: '30',
                      prefixIcon: Icon(Icons.arrow_upward, size: 18, color: cs.primary),
                      helperText: 'Entre -50 e 70 °C',
                    ),
                    keyboardType: TextInputType.number,
                    validator: (value) {
            ...
            Row(
              children: [
                Icon(Icons.opacity, size: 18, color: cs.primary),
                const SizedBox(width: 8),
                Text(
                  'Umidade (%)',
                  style: TextStyle(
            ...
            DropdownButtonFormField<String>(
              ...
              decoration: InputDecoration(
                prefixIcon: Icon(Icons.light_mode, color: cs.primary),
                helperText: 'Quantidade de luz solar necessária',
              ),
              items: _lightOptions
                  .map(
                    (e) => DropdownMenuItem(
