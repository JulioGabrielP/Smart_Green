...
class PlantCardWidget extends StatelessWidget {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            // Temperatura média
                            if (plant.mediaTemperatura != null) ...[
                              _metric(
                                cs,
                                Icons.thermostat,
  ...
  Widget _buildStatusBadge() {
    final color = _colorFromStatus(plant.status);
    final text = _statusText(plant.status);
  ...
  Widget _metric(ColorScheme cs, IconData icon, String text, Color color) {
    return Row(
